# Default config, but with correct treatment of WEB_CONCURRENCY as an int
# can be removed when https://github.com/bynect/hypercorn-fastapi-docker/pull/1 is merged
